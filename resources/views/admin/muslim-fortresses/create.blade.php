...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('app.muslim_fortress') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.muslim-fortresses.store") }}">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('content') ? 'is-invalid' : '' }} ckeditor" name="content" required>{{ old('content', '') }}</textarea>
