            ...
            <form method="POST" action="{{ route('admin.audios.update', [$audio->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title"
                        id="title" value="{{ old('title', $audio->title) }}" required>
                    @if ($errors->has('title'))
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('content') ? 'is-invalid' : '' }}" name="content"
                        id="content">{!! old('content', $audio->content) !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <x-media-library-collection name="files" :model="$audio" collection="files" {{-- fields-view="layouts.duration_field" --}} />
                    <span class="help-block">{{ trans('cruds.audio.fields.files_helper') }}</span>
                </div>
                <div class="form-group">
                    <label for="images">{{ trans('cruds.audio.fields.images') }}</label>
                    <x-media-library-collection name="images" :model="$audio" collection="images" />
