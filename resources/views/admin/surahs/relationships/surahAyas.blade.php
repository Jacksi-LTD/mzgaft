                    ...
                    <tbody>
                        @foreach($ayas as $key => $aya)
                            <tr data-entry-id="{{ $aya->id }}">
                                ...
                                <td>
                                    @can('aya_show')
                                        <a class="btn btn-xs btn-primary" href="{{ route('admin.ayas.show', $aya->id) }}">
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan
                                    ...
                                    @can('aya_delete')
                                        <form action="{{ route('admin.ayas.destroy', $aya->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@endcan
  ...
  let table = $('.datatable-surahAyas:not(.ajaxTable)').DataTable({ buttons: dtButtons })
