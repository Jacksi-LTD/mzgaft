...
@section('content')
    <div class="card">
        <div class="card-header">
            {{ trans('global.create') }} {{ trans('app.tajweeds books') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route('admin.tajweeds.store') }}" enctype="multipart/form-data">
                @csrf
...
@section('scripts')
    ...
    <script>
        Dropzone.options.imageDropzone = {
            url: '{{ route('admin.tajweeds.storeMedia') }}',
