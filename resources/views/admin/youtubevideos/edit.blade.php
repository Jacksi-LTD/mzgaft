...
@section('content')
    <div class="card">
        <div class="card-header">
            {{ trans('global.edit') }} {{ trans('app.youtubevideos') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route('admin.youtubevideos.update', [$edit->id]) }}"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('url') ? 'is-invalid' : '' }}" type="url" name="url"
                           id="title" value="{{ $edit->url }}" required>
                    @if ($errors->has('url'))
                ...
                <div class="form-group">
                    <div class="form-check {{ $errors->has('approved') ? 'is-invalid' : '' }}">
                        ...
                        <input class="form-check-input" type="checkbox" name="approved" id="approved" value="1"
                            {{ $edit->approved || old('approved', 0) === 1 ? 'checked' : '' }}>
...
@section('scripts')
    ...
    <script>
        ...
        Dropzone.options.audioDropzone = {
            ...
            init: function() {
                @if (isset($edit) && $edit->audio)
                    var files =
                        {!! json_encode($edit->audio) !!}
                    for (var i in files) {
                        var file = files[i]
                        this.options.addedfile.call(this, file)
                        file.previewElement.classList.add('dz-complete')
