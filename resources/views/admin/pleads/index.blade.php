...
@section('content')
    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.pleads.create') }}">
                {{ trans('global.add') }} {{ trans('app.pleads') }}
            </a>
        </div>
    </div>
...
<div class="card">
    <div class="card-header">
        {{ trans('app.pleads') }} {{ trans('global.list') }}
    </div>
