...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('app.pleads') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.pleads.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('details') ? 'is-invalid' : '' }} ckeditor"  name="details"  required>{{ old('details', '') }}</textarea>
...
<script>
    ...
    init: function () {
@if(isset($plead) && $plead->audio_file && $plead->audio_file->count() > 0)
      var file = {!! json_encode($plead->audio_file->first()) !!}
