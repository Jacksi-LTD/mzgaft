...
<head>
    ...
    <!-- ***** to resolve uploading files in frontend ***** -->
                ...
                <div class="main-menu-container ">
                    ...
                    <div class="duplicated-box box-lg">
                        ...
                        <div class="box-body box-padding">
                            ...
                            <div class="body-type main-menu-items">

                                <div class="row row-cols-xl-6 row-cols-lg-3 row-cols-sm-2 row-cols-1 justify-content-center">

                                    <div class="item-wrap">

                                        <a class="menu-item" href="{{route('frontend.home')}}"><span>الرئيسية</span></a>

                                    </div>
                                    <div class="item-wrap">

                                        <a class="menu-item" href="{{route('frontend.tafsir.index')}}"> <span>تفسير القرآن</span></a>

                                    </div>
                                    <div class="item-wrap">

                                        <a class="menu-item" href="{{route('frontend.blogs.index')}}"><span>المقالات</span> </a>

                                    </div>
                                    <div class="item-wrap">

                                        <a class="menu-item" href="{{route('frontend.audios.index')}}"> <span>الصوتيات</span> </a>

                                    </div>
                                    <div class="item-wrap">

                                        <a class="menu-item" href="{{route('frontend.audio-books.index')}}"> <span>الكتب الصوتية</span> </a>

                                    </div>
                                    <div class="item-wrap">

                                        <a class="menu-item" href="{{route('frontend.books.index')}}"> <span>الكتب</span></a>

                                    </div>

                                    <div class="item-wrap">

                                        <a class="menu-item" href="{{route('frontend.questions.index')}}">  <span>اسالة واجوبة</span> </a>
