                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.audios.update", [$audio->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $audio->title) }}" required>
                            @if($errors->has('title'))
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="approved" id="approved" value="1" {{ $audio->approved || old('approved', 0) === 1 ? 'checked' : '' }}>
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('frontend.audios.storeCKEditorImages') }}', true);
