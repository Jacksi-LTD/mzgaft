                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.questions.update", [$question->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $question->title) }}">
                            @if($errors->has('title'))
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="question" id="question">{!! old('question', $question->question) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="answer" id="answer">{!! old('answer', $question->answer) !!}</textarea>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="approved" id="approved" value="1" {{ $question->approved || old('approved', 0) === 1 ? 'checked' : '' }}>
