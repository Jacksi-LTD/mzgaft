        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.blogs.update', [$blog->id]) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control date" type="text" name="writing_date" id="writing_date"
                                    value="{{ old('writing_date', $blog->writing_date) }}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="writer_id" id="writer_id">
                                    @foreach ($writers as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('writer_id') ? old('writer_id') : $blog->writer->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="category_id" id="category_id">
                                    @foreach ($categories as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ (old('category_id') ? old('category_id') : $blog->category->id ?? '') == $id ? 'selected' : '' }}>
                                            {{ $entry }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <input type="checkbox" name="approved" id="approved" value="1"
                                        {{ $blog->approved || old('approved', 0) === 1 ? 'checked' : '' }}>
