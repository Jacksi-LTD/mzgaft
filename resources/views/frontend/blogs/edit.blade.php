                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.blogs.update", [$blog->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="writing_date" id="writing_date" value="{{ old('writing_date', $blog->writing_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="content" id="content">{!! old('content', $blog->content) !!}</textarea>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="approved" id="approved" value="1" {{ $blog->approved || old('approved', 0) === 1 ? 'checked' : '' }}>
