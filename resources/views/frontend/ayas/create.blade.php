    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.ayas.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="aya">{{ trans('cruds.aya.fields.aya') }}</label>
                            <input class="form-control" type="text" name="aya" id="aya" value="{{ old('aya', '') }}" required>
                            @if($errors->has('aya'))
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="tafsir" id="tafsir">{!! old('tafsir') !!}</textarea>
