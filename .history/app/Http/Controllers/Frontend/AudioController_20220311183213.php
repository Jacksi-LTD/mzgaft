...
class AudioController extends Controller
{
    ...
    {
        $audios = Audio::with(['writer', 'category', 'created_by', 'media'])->where('writer_id', $person->id)->get();

        $some_audios = Audio::with(['writer', 'category', 'created_by', 'media'])->get();

        $category = Category::where('type', 'audios')->first();

        return view('frontend.audios.category', compact('audios', 'some_audios', 'category', 'person'));
    }
