...
Route::group(['as' => 'frontend.', 'namespace' => 'Frontend'], function () {
    ...
    Route::get('audios/category/{category}', 'BlogController@category')->name('audios.category');
    Route::get('audios/person/{people}', 'BlogController@people')->name('audios.people');
