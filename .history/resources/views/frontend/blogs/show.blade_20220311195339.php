...
@section('breadcrumb')
    ...
    @php
    $parent = $blog->category->parentCategory;
    $up_parent = $parent->parentCategory;
    @endphp
    <li class="breadcrumb-item"><a href="{{ route('frontend.blogs.category', $parent->id) }}">{{ $parent->name }}</a></li>
    @if ($up_parent)
        <li class="breadcrumb-item"><a href="{{ route('frontend.blogs.category', $up_parent->id) }}">{{ $up_parent->name }}</a>
        </li>
    @endif
@endsection
    ...
    <div class="container">
        ...
        <div class="article-detalis-box">
            ...
            <div class="share-article">
                ...
                <div class="share-article-items">

                    <span class="share-item share-text">شارك المقالة</span>

                    <a class="share-item share-link" href="#">

                        <svg xmlns="http://www.w3.org/2000/svg" width="21.333" height="15" viewBox="0 0 21.333 15">
                            <path id="youtube"
                                d="M35.821,66.347a2.681,2.681,0,0,0-1.886-1.9C32.271,64,25.6,64,25.6,64s-6.671,0-8.335.449a2.681,2.681,0,0,0-1.886,1.9,30.181,30.181,0,0,0,0,10.336,2.641,2.641,0,0,0,1.886,1.868C18.929,79,25.6,79,25.6,79s6.671,0,8.335-.449a2.641,2.641,0,0,0,1.886-1.868,30.181,30.181,0,0,0,0-10.336Zm-12.4,8.34V68.343l5.576,3.172Z"
                    ...
                    <a class="share-item share-link" href="#">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15">
                            <path id="linkedin-in"
                                d="M3.358,15.01H.248V5h3.11ZM1.8,3.629A1.81,1.81,0,1,1,3.6,1.811,1.816,1.816,0,0,1,1.8,3.629ZM15,15.01h-3.1V10.135c0-1.162-.023-2.652-1.617-2.652-1.617,0-1.865,1.262-1.865,2.568V15.01H5.306V5H8.288V6.361h.044a3.268,3.268,0,0,1,2.942-1.617C14.422,4.744,15,6.817,15,9.509v5.5Z"
                                transform="translate(0 -0.01)" fill="#0e76a8" />
                        </svg>
                    ...
                    <a class="share-item share-link" href="#">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            width="15.003" height="15" viewBox="0 0 15.003 15">
                            <defs>
                                <linearGradient id="linear-gradient" x1="0.14" y1="0.046" x2="0.861" y2="0.965"
                    ...
                    <a class="share-item share-link" href="#">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="8.034" height="15" viewBox="0 0 8.034 15">
                            <path id="facebook-f"
                                d="M30.4,8.438l.417-2.715h-2.6V3.961a1.357,1.357,0,0,1,1.53-1.467h1.184V.183A14.441,14.441,0,0,0,28.822,0a3.314,3.314,0,0,0-3.547,3.654V5.723H22.89V8.438h2.384V15h2.935V8.438Z"
                                transform="translate(-22.89)" fill="#4267b2" />
                        </svg>
